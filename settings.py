...
USER_DATA_POPULATED = 'inserted_users/inserted_users.txt'
...
#Clear memory
CLEAR_MEMORY = 23 #Suggested 35 per 8 gigs of ram (eg. 35 at 8gigs, 70 at 16gigs)
RESET_COUNT = 5
RESET_TXT = 'reset_count.txt'
